<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
					...
					array(
                        ...
                        'type'      => 'switch',
                        'title'     => esc_html__('Search only for products?', 'nexx'),
                        'subtitle'  => esc_html__('If enabled, search will be made only for products.', 'nexx'),
                        'default'   => 1,
                        'on'        => esc_html__('Enabled', 'nexx'),
                        'off'       => esc_html__('Disabled', 'nexx'),
    ...
    Redux::setSection( $opt_name, array(
        'id'			=> 'nxr_woocommerce',
		'icon'		=> 'el el-picture',
		'title'		=>	esc_html__('WooCommerce', 'nexx'),
        'fields'		=> array(
			!class_exists( 'WooCommerce' ) ? 
			array(
				'id'    => 'top_info_bar',
				'type'  => 'info',
				'style' => 'critical',
				'title' => esc_html__( 'WooCommerce Error', 'nexx' ),
				'desc'  => sprintf( __( '<b>WooCommerce</b> is not active. Please install/activate <a href="%s">here</a>', 'nexx' ), admin_url('plugins.php') ),
				'required'	=> array('woo_support', '=', '1'),
			) : NULL,
			array(
				'id'			=>	'woo_support',
				'type'		=>	'switch',
				'title'		=>	esc_html__('Enable WooCommerce Support?', 'nexx'),
				'subtitle'	=>	esc_html__('If "Yes", the theme offers support for WooCommerce. Please install and activate WooCommerce before activating this option.', 'nexx'),
				'default'	=>	'0',
				'on'			=>	'Yes',
				'off'		=>	'No',
			),
			array(
				'id'			=>	'products_per_row',
				'type'		=>	'select',
				'title'     => esc_html__('Products per row', 'nexx'),
				'subtitle'  => esc_html__('How many products do you want to display on a row?', 'nexx'),
				'options'   => array(
					'2' => '2',
					'3' => '3', 
					'4' => '4',
			...
			array(
				...
				'title'				=>	esc_html__('Body Font for shop content', 'nexx'),
				'subtitle'			=>	esc_html__('Specify the body font properties.', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
			...
			array(
				...
				'title'				=>	esc_html__('Listing Product Title', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for product title on the listing page.', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'title'				=>	esc_html__('Listing Price', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for product price on the listing page.', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'title'				=>	esc_html__('Single Product Title', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for product title on the single product page.', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'title'				=>	esc_html__('Single Product Price', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for product price on the single product page.', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'title'				=>	esc_html__('Form titles', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for form titles (Ex: Billing address on Checkout Page).', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				'id'        => 'section_minicart',
				'type'      => 'section',
				'title'     => esc_html__('Minicart', 'nexx'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
				'required' 	=>	array('woo_support', "=", 1),
			),
			array(
				...
				'required' 		=>	array('woo_support', "=", 1),
				'type'			=> 'color',
				'title'			=>	esc_html__('Minicart Icon Color', 'nexx'), 
				'subtitle'		=>	esc_html__('Pick a color for cart icon on the header.', 'nexx'),
				'default'		=> '#000000',
				'validate'		=> 'color',
				'transparent'	=>	false,	
			...
			array(
				'id'        	=>	'woo_bubble_color',
				'type'      	=>	'link_color',
				'title'		=>	esc_html__('Minicart bubble color', 'nexx'), 
				'subtitle'	=>	esc_html__('Pick a color for the mini-cart bubble.', 'nexx'),
				'desc'      	=>	esc_html__('Setup links color on regular and hovered state.', 'nexx'),
				'regular'   	=>	true,
				'hover'     	=>	true,
				'active'    	=>	false,
			...
			array(
				...
				'required' 		=>	array('woo_support', "=", 1),
				'type'			=> 'color',
				'title'			=>	esc_html__('Minicart Bubble text color ', 'nexx'), 
				'subtitle'		=>	esc_html__('Color of the text into the minicart bubble (qty).', 'nexx'),
				'default'		=> '#ffffff',
				'validate'		=> 'color',
				'transparent'	=>	false,	
				'compiler'		=>	array('a.nxr_woo_minicart_content, .blog a.nxr_woo_minicart_content, div.woo_bubble a.nxr_woo_minicart_content'),
				'output'			=>	array('a.nxr_woo_minicart_content, .blog a.nxr_woo_minicart_content, div.woo_bubble a.nxr_woo_minicart_content'),
			),
			array(
				'id'        => 'section_qcv',
				'type'      => 'section',
				'title'     => esc_html__('Quick Cart View', 'nexx'),
				'indent'    => true, // Indent all options below until the next 'section' option is set.
				'required' 	=>	array('woo_support', "=", 1),
			),
			array(
				'id'        => 'qcv_bg_color',
				'type'      => 'color_rgba',
				'title'		=>	esc_html__('Quick Cart View Background Color', 'nexx'),
			...
			array(
				'id'        => 'qcv_border',
				'type'      => 'border',
				'title'     => esc_html__('Quick Cart View Border', 'nexx'),
				'compiler'	=> array('.qcv_container'),
				'output'    => array('.qcv_container'),
				'desc'      => esc_html__('Setup Quick Cart View border, in pixels (top, right, bottom, left).', 'nexx'),
				'all'       => false,
				'default'   => array(
					'border-color'  => '#cecece', 
					'border-style'  => 'solid', 
			...
			array(
				...
				'title'				=>	esc_html__('QuickCart View Item Title', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for QCV Items title', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'title'				=>	esc_html__('QuickCart View Item SubTotal', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for QCV Items Subtitle', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'title'				=>	esc_html__('QuickCart All Items SubTotal', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for QCV Items Subtotal', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'type'      	=>	'link_color',
				'title'		=>	esc_html__('Go To Cart Button Background Color', 'nexx'), 
				'regular'   	=>	true,
				'hover'     	=>	true,
				'active'    	=>	false,
				'visited'   	=>	false,
			...
			array(
				...
				'type'      	=>	'link_color',
				'title'		=>	esc_html__('Checkout Button Background Color', 'nexx'), 
				'regular'   	=>	true,
				'hover'     	=>	true,
				'active'    	=>	false,
				'visited'   	=>	false,
			...
			array(
				...
				'title'				=>	esc_html__('Quick Cart View Buttons Font', 'nexx'),
				'subtitle'			=>	esc_html__('Specify font properties for QCV buttons', 'nexx'),
				'google'				=>	true,
				'color'				=>	true,
				'text-transform'	=>	true,
				'default'			=>	array(
			...
			array(
				...
				'data'		=> 'posts',
				'args'		=> array('post_type' => 'page', 'nopaging' => true),
				'title'		=> esc_html__( 'Custom "Empty Cart" page', 'nexx' ),
				'subtitle'	=> esc_html__( 'Select your custom empty cart page.', 'nexx' ),
				'desc'		=> esc_html__( 'Go to pages and create your custom empty cart page. After this, you can select it from here.', 'nexx' ),
			),
		)
    ) );
