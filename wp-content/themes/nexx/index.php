 ...
 */
	...
	$nxr_page_color_scheme	=	get_post_meta( $this_page_id, '_nxr_page_color_scheme', true );
 ?>
...
<!-- blog content -->
<div class="row blogPosts <?php echo (isset($nxr_options['blog_color_scheme']) ? esc_attr($nxr_options['blog_color_scheme']) : '');?>" id="blogPosts">
  <div class="container"> 
    <!-- posts -->
