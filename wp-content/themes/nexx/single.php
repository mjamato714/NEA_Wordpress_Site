 ...
 */
 ...
 ?>
<!-- SINGLE BLOG POST -->
<div class="row blog blogPosts <?php echo (isset($nxr_options['blog_color_scheme']) ? esc_attr($nxr_options['blog_color_scheme']) : '');?>" id="blogPosts">
  <div class="container"> 
    <!-- posts -->
    <div class="vc_col-md-9 vc_col-sm-12 vc_col-xs-12">
      ...
      <div <?php post_class('post'); ?>>
       ...
       <?php // Paginated post
			$args = array(
				'before'           => '<div class="post_pagination">' . esc_html__( 'Post page: ','nexx' ),
				'after'            => '</div>',
				'link_before'      => '',
				'link_after'       => '',
