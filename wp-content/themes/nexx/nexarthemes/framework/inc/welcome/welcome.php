    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'nexx' );
            }
        ...
        public function about_screen() {
			...
			get_template_part('nexarthemes/framework/inc/welcome/views/about');
        ...
        public function changelog_screen() {
            ...
            get_template_part('nexarthemes/framework/inc/welcome/views/changelog');
        ...
        public function redux_extensions() {
            ...
            get_template_part('nexarthemes/framework/inc/welcome/views/extensions');
        ...
        public function get_support() {
            ...
            get_template_part('nexarthemes/framework/inc/welcome/views/support');
        ...
        public function credits_screen() {
            ...
            get_template_part('nexarthemes/framework/inc/welcome/views/credits');
        ...
        public function status_screen() {
            ...
            get_template_part('nexarthemes/framework/inc/welcome/views/status_report');
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'nexx' ), esc_html($contributor->login) ) )
                );
