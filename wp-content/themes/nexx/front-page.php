<?php
/**
 * Nexx Theme: Home page for site or blog
 * @package WordPress
 ...
 */
 	...
 	$nxr_page_color_scheme	=	esc_attr( get_post_meta( $this_page_id, '_nxr_page_color_scheme', true ) );
...
<?php if( is_home() ) : ?>
        ...
        <div class="header_image_container"> <img src="<?php header_image(); ?>" height="<?php echo get_custom_header()->height; ?>" width="<?php echo get_custom_header()->width; ?>" alt="<?php echo get_bloginfo('name'); ?>" class="header_image" />
          <div class="headerWelcome">
            ...
            <h2><a href="#" class="readTheBlogBtn"><?php esc_attr( 'Read the blog', 'nexx' );?></a></h2>
          </div>
        </div>
        <!-- Header Image End -->
        <?php endif;?>
        ...
        <div class="row blogPosts <?php echo esc_attr( (isset($nxr_options['blog_color_scheme']) ? $nxr_options['blog_color_scheme'] : '') );?>" id="blogPosts">
          <div class="container"> 
            <!-- posts -->
