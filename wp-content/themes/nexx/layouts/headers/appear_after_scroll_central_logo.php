...
<!-- APPEAR AFTER SCROLL - CENTRAL LOGO -->

<?php
 $nxr_options = get_option( 'redux_options' );
?>

<div id="nxr_top_navbar_container" class="central_logo nxr_hidden_before_scroll nxr_navbar <?php echo ( !is_front_page() ? '' : ( $nxr_options['header_floating'] == 2 ? 'hidden' : '') ); ?>">
