...
<div id="nxr_top_navbar_container" class="central_logo nxr_shrink_after_scroll nxr_navbar <?php echo ( !is_front_page() ? '' : ( $nxr_options['header_floating'] == 2 ? 'hidden' : '') ); ?>">
    ...
    <?php
        ...
        $left_menu = array(
            ...
            'link_before'     => '',
            'link_after'      => '',
            'items_wrap'      => '<ul id="main_navbar_left" class="%2$s">%3$s</ul>',
            'depth'           => 4,
